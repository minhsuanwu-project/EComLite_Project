...
## AdminOrdersTests (9/9 passed)

- [PASS] EComLite.Tests.AdminOrdersTests.AdminOrdersPage_RequiresAuthorization
- [PASS] EComLite.Tests.AdminOrdersTests.AdminOrdersPage_RestrictsToAdminRole
- [PASS] EComLite.Tests.AdminOrdersTests.AdvancingStatus_OneStepForward_IsApplied
- [PASS] EComLite.Tests.AdminOrdersTests.AdvancingStatus_SkippingAStage_IsRejectedAndStatusUnchanged
- [PASS] EComLite.Tests.AdminOrdersTests.ChangingStatus_OnMissingOrder_Fails
- [PASS] EComLite.Tests.AdminOrdersTests.NextStatus_ForDeliveredOrder_IsNone
- [PASS] EComLite.Tests.AdminOrdersTests.NextStatus_IsTheSingleAllowedForwardStep(current: "Pending", expected: "Processing")
- [PASS] EComLite.Tests.AdminOrdersTests.NextStatus_IsTheSingleAllowedForwardStep(current: "Processing", expected: "Shipped")
- [PASS] EComLite.Tests.AdminOrdersTests.NextStatus_IsTheSingleAllowedForwardStep(current: "Shipped", expected: "Delivered")
